...
lux::net::base::http_server_ptr net::http_factory::create_http_server(const lux::net::base::http_server_config& config,
                                                                      lux::net::base::http_server_handler& handler)
{
    return std::make_unique<lux::net::http_server>(config, handler, socket_factory_);
}

lux::net::base::http_server_ptr net::http_factory::create_https_server(const lux::net::base::http_server_config& config,
                                                                       lux::net::base::http_server_handler& handler,
